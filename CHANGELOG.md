...
### Changed (Trust & compliance)

- Relicense project to **Apache-2.0** (`LICENSE`, `pyproject.toml`, README, CONTRIBUTING); see [LICENSE-AUDIT.md](LICENSE-AUDIT.md).
- README: **canonical repository** = GitHub (`BAQIS-Quantum/ErrorGnoMark`); Gitee documented as China mirror.
- README: clarify **QEC-ready data abstractions** vs **logical benchmark protocols** (planned / in development).

### Notes

- No intentional functional API changes intended in this release.
...
[3.0.3]: https://github.com/BAQIS-Quantum/ErrorGnoMark/compare/v3.0.2...v3.0.3
