# errorgnomark/analysis/benchmarking/entanglement_verification/__init__.py

"""
Entanglement Verification Module
================================

This package provides a suite of experiments and analysis tools for generating
and verifying standard entangled states, such as Bell, GHZ, and W states.
